                                                                                ...
                                                                                <td className="px-4 py-2 text-center">
                                                                                    <div className="flex flex-wrap gap-1 justify-center max-w-[120px]">
                                                                                        {['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado'].map(day => {
                                                                                            const isSelected = editAssignmentData.schedule?.some(s => s.day === day);
                                                                                            return (
                                                                                                <button 
                                                                                                    key={day} 
                                                                                                    type="button"
                                                                                                    onClick={() => toggleEditDay(day)}
                                                                                                    className={`text-[10px] px-1.5 py-0.5 rounded ${isSelected ? 'bg-primary text-white' : 'bg-slate-200 text-slate-600 dark:bg-slate-700 dark:text-slate-400'}`}
                                                                                                    title={day}
                                                                                                >
                                                                                                    {day.substring(0, 2)}
                                                                                                </button>
                                                                            ...
                                                                            <>
                                                                                ...
                                                                                <td className="px-4 py-2 text-center text-xs text-slate-500 dark:text-slate-400">
                                                                                    {assignment.schedule && assignment.schedule.length > 0 
                                                                                        ? assignment.schedule.map(s => s.day.substring(0, 2)).join(', ') 
                                                                                        : 'No asignado'}
                                                                                </td>
                                                                                <td className="px-4 py-2 text-center">
                                                                                    <div className="flex justify-center gap-2">
